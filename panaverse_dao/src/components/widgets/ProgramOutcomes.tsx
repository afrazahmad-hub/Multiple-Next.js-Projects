...
const ProgramOutcomes = () => {
  ...
  return (
    <section>
      <Wrapper>
        <div className="flex flex-col-reverse md:flex-row mt-10 md:m-8 items-center">
          <div className=" flex-1">
            {/* Left Image */}
            <Image src={Heroposter} alt="Program outcome img" />
          </div>
          <div className="flex-1">
            {/* Right content */}
            ...
            <div className="grid grid-cols-2  mt-4 gap-x-6 gap-y-6 text-slate-600">
